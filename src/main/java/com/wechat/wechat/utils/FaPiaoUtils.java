...
public class FaPiaoUtils {
    ...
    public static Boolean applyTicket(String platformTid,
                            String serialNo,
                            String payeeAddress,
                            String payeeName,
        ...
        TaobaoClient client = new DefaultTaobaoClient("http://gw.api.taobao.com/router/rest","24927248","7dce982afa9d0d7fc079fbe1c3417b6d");
        ...
        req.setPayerBankaccount(payerBankaccount);//付款方开票开户银行及账号
    ...
    public static void main(String[] args) {
        String ticket = getTicket("20141234123412341","201712121708060405","91310230MA1K05DW59");
